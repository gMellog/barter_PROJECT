      ...
      <div className={styles.wrapper_available_offer_products}>
        ...
        <div className={styles.wrapper_available_offer_product_content}>
          <div className={styles.available_offer_product_item}>
            ...
            />
            <span className={styles.available_product_sign}>Джинсы Сomiks</span>
          </div>
          <div className={styles.available_offer_product_item}>
            <img
              src={product_offer_2}
              ...
              className={styles.available_product_icon}
            />
            <span className={styles.available_product_sign}>Шины Nichlen</span>
          </div>
          <div className={styles.available_offer_product_item}>
            <img
              src={product_offer_3}
              ...
              className={styles.available_product_icon}
            />
            <span className={styles.available_product_sign}>Часы PROLLIX</span>
          </div>
          <div className={styles.available_offer_product_item}>
            <img
              src={product_offer_4}
