...
function dbConnect() {
    mongoose.connect(dbConnectionURL, options, async (err) => {
        ...
        const titles = ["Книга","Шапка", "Кепка", "Кроссовки", "Ботинки", "Туфли", "Шорты", "Рубашка", "Джинсы", "Брюки", "Куртка", "Ручка", "Стол", "Очки", "Айфон", "Велосипед", "Стул", "Сумка", "Кровать", "Диван", "Рюкзак", "Платье", "Часы", "Кресло", "Самокат", "Мопед", "Люстра", "x-box", "Ноутбук", "Наушники"];
